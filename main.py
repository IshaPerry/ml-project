...
st.markdown(" Our objective with this project is to be able to train a model to correctly classify AI generated images vs real images with more accuracy than a human."
