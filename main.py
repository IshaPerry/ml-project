...
st.title("Methods")
pca, cnn, nb, lr = st.tabs(["Principal Component Analysis (PCA)", "Convolutional Neural Network (CNN)", "Naive Bayes Classifier", "Logistic Regression"])
...
lr.code( "logreg = LogisticRegression(C = 0.15)\nresults = logreg.fit(x_train, y_train)\ny_pred = logreg.predict(x_test)\nscore = logreg.score(x_test, y_test)\nprint('logistic regression accuracy: ' + str(score))", language="python" )



st.divider()
st.title("Results and Discussions:")
pca, cnn, cnnwpca, nb, lr = st.tabs(["Principal Component Analysis (PCA)", "Convolutional Neural Network (CNN)", "Convolutional Neural Network with PCA Processed Data", "Naive Bayes Classifier", "Logistic Regression"])
...
st.write("Below is our Gantt Chart depicting the steps we have taken to complete the project. Here is a link to our gantt chart: https://drive.google.com/file/d/1RDsISOcSNLwdXwvQJjfrbmRLNtUDY9CT/view?usp=sharing")
